...
public class SubCreateCustomer extends SuperTestScript
{
@Test
public void testSubCreateCustomer()
{
	...
	{
		TestngExcelOperation.writeData("TC_05", 1, 7, "pass");
	}
	else
	{
		TestngExcelOperation.writeData("TC_05", 1, 7, "fail");
	}
}
